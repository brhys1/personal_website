  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold text-slate-800 mb-6">Rhys Burman</h1>
            <p className="text-2xl md:text-3xl text-blue-600 mb-8">Data Scientist & Sustainability Expert</p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-slate-800 mb-16">Skills & Expertise</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {skills.map((skillGroup, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <CardTitle className="text-xl text-blue-600">{skillGroup.category}</CardTitle>
                </CardHeader>
                <CardContent>
